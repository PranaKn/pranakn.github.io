...
image:
  ...
  alt: BlueTeam Labs SOC - 22/04/26
---
...
But you could also think of it like layers of an onion, an artichoke - or any foo you like, as long as it has layers or holes you can stack to cover each other’s gap. These analogies change over time, so maybe swiss cheese get replaced one day. Maybe it becomes a dragon fruit…although at that point, we’ve probably lost the plot, and the pizza.

...
Pizza is gone. Time to act, lock the doors, check the logs, restart the AI Robot (which won’t help much, it keeps the CEO happy), and maybe have a serious talk with Bob. 
...
Numbers to show to management to prove the pizza is under control
...
This is the first post o many in a small journey from beginner to advance blue team topics.
